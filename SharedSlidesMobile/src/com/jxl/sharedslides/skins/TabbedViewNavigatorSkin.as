...
package com.jxl.sharedslides.skins
{
	...
	public class TabbedViewNavigatorSkin extends MobileSkin
	{
		...
		private var backgroundSymbol:BackgroundSymbol;
		...
		{
			backgroundSymbol = new BackgroundSymbol();
			addChild(backgroundSymbol);
		...
		override protected function layoutContents(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			backgroundSymbol.x = contentGroup.x;
			backgroundSymbol.y = contentGroup.y;
			backgroundSymbol.width = contentGroup.width + 2;
			backgroundSymbol.height = contentGroup.height + 2;
		}
	}
}